...
async function main() {
  ...
  try {
    ...
    console.log(JSON.stringify({ app: app.id, url: baseUrl, outputDir, results, contentKinds, graphMutation, blueprintContextMutation, stateMachineMutation, goapActionCount, errors }, null, 2));
    if (failures.length) {
